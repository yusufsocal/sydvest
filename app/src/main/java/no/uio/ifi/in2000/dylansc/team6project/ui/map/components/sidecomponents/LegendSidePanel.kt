...
/**
 * Side panel that wraps the compact [LegendCard] and an info button.
 * Tapping the info button opens the full [LegendDialog] legend dialog.
 */
